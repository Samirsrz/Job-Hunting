...
// import { FaRegBookmark, FaMapMarkerAlt, FaBriefcase, FaRupeeSign, FaStar } from 'react-icons/fa'; // Importing icons for visual elements
// import { AiFillStar } from 'react-icons/ai'; // For the rating star icon
...
//     let [btnDrop,setBtnDrop]=useState('')

//     function handleToggle(e) {
//         setBtnDrop(e.target.innerText)
//         setToggle(!toggle)
//         console.log(toggle);
//     }
//     return (
...
//                     <button className='px-4 py-2 rounded-3xl border border-black' onClick={() => handleToggle(event)}>Department</button>
//                     <button className='px-4 py-2 rounded-3xl border border-black' onClick={() => handleToggle(event)}>Location</button>
//                     <button className='px-4 py-2 rounded-3xl border border-black' onClick={() => handleToggle(event)}>Eperience</button>
//                 </div>


//                 {
//                     btnDrop === 'Department' && <div className='absolute'><FilterComponent btnDrop={btnDrop} setBtnDrop={setBtnDrop} /> </div> 
//                 }
//                 {
//                     btnDrop === 'Location' && <div className='absolute'><LocationFilterComponent /> </div> 
//                 }
//                 {
//                     btnDrop === 'Eperience' && <div className='absolute'><ExperienceSlider /> </div> 
//                 }
...
//                             {/* Company Logo */}
//                             <img
//                                 src={companyLogo} // Replace this with the path to the logo
//                                 alt="Company Logo"
//                                 className="w-10 h-10"
//                             />
//                         </div>
...
//                             <p className='flex gap-1 items-center'><MdOutlineContactPage /> Preferred candidate profile . .</p>
...
//                         {/* Footer: Date Posted and Save Button */}
...
//                 <aside className=''>
//                     <div id='' className='w-full border rounded-xl p-4'>

//                         <div className='flex justify-between w-full'>
//                             <div className='space-y-2 w-full'>
//                                 <h3 className='font-semibold'>Love jobs by Standard <br /> Chartered?</h3>
