            ...
            {challenge.map((event, index) => (
              <div className="px-2" key={index}> {/* Added padding to create gap between cards */}
                <aside className="p-4 bg-white rounded-xl relative border-[2px]">
                  ...
                  <div className="relative">
                    <img
                      src={event.coverPhoto || eventImage} // Use event's cover photo or fallback image
                      alt="Event"
                      className="rounded-t-xl h-36 w-full object-cover"
                    />
                    <div className="absolute top-2 left-2 bg-purple-500 text-white text-xs px-2 py-1 rounded-md">
                  ...
                  <div className="mt-3">
                    <div className="flex gap-3 items-center">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">{event.companyName}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between mt-3 text-sm text-gray-500">
                    <div className="flex items-center">
                      <FaCalendarAlt className="mr-1" />
                      <span>{event.date}, {event.time}</span> {/* Event date and time */}
                    </div>
                    <div className="flex items-center">
                      <FaUserAlt className="mr-1" />
                      <span>{event.enrolled} Enrolled</span> {/* Enrolled count */}
                    </div>
                  </div>
