  ...
  return (
    <section className="bg-[#5900f4f9] mt-12 relative flex justify-between flex-col lg:flex-row gap-3 items-center lg:h-[200px] rounded-3xl">
      ...
      <article className='text-center lg:text-left '  >
        <h1 className='font-bold text-3xl text-white px-3 lg:p-0'>{t('Bangladesh&rsquo;sbiggestskillcontest')}  <br/> {t('tohelpyoustandouttoreqruiters')}</h1>
      ...
      <article className= 'my-3 lg:my-0'>
        <button className='font-bold text-3xl bg-yellow-400 rounded-3xl px-4 py-2 mr-3'>{t('Tellmemore')}</button>
      </article>
    </section>
  );
};
