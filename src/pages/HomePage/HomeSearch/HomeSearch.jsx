...
const HomeSearch = () => {
    ...
    return (
        <div className='max-w-6xl mx-auto p-4 mb-8'>
            <h1 className='text-center text-4xl font-bold mb-2 mt-8'>{t('FindYourDreamJobNow')}</h1>
            <p className='text-center text-lg mb-8 text-gray-700'>{t('Over500,000jobsforyoutoexplore')}</p>
