...
const HomeSearch = () => {
  ...
  const [isLocationSuggestionVisible, setIsLocationSuggestionVisible] =
    useState(false);
  ...
  const {
    ...
    error,
    isError,
  } = useGetJobsSearchQuery({ location, query }, { skip: !searchTrigger });
  ...
  return (
    <FadeIn>
      <div className="max-w-screen-xl m-auto p-4 md:pt-24 mt-7">
        <h1 className="text-center text-4xl font-bold m-4">
          {t("FindYourDreamJobNow")}
        </h1>
        <p className="text-center text-lg font-thin">
          {t("Over500,000jobsforyoutoexplore")}
        </p>
