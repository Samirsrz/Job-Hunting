...
//     const { data: jobs, isLoading, isError } =useGetJobsSearchQuery({ location, type });
    ...
    return (
        <div className='max-w-screen-xl m-auto p-4'>
            ...
            <div className='mt-4'>
                ...
                {jobs && jobs.length > 0 && <button onClick={()=>navigateToJobsPage(jobs)}>click</button>}
...
//     // Function to handle when a job suggestion is clicked
//     const handleJobSuggestionClick = (suggestion) => {
//         setQuery(suggestion); // Set the clicked suggestion as the query
//         setIsJobSuggestionVisible(false); // Hide the job suggestions list
//     };

//     // Function to handle when a location suggestion is clicked
//     const handleLocationSuggestionClick = (suggestion) => {
//         setLocation(suggestion); // Set the clicked suggestion as the location
//         setIsLocationSuggestionVisible(false); // Hide the location suggestions list
//     };
...
//     // When jobs are fetched, reset the searchTrigger to avoid refetching on each render
//     useEffect(() => {
//         if (jobs && searchTrigger) {
//             console.log('Fetched Jobs:', jobs);
//             setSearchTrigger(false); // reset trigger to prevent refetching on each render
...
//                     {/* Button to navigate to Jobs page */}
//                     <button
//                         onClick={navigateToJobsPage}  // Navigate when clicked
